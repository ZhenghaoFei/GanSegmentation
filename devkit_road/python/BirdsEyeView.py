...
class BevParams(object):
    ...
    def __init__(self, bev_res, bev_xLimits, bev_zLimits, imSize):
        ...
        @param imSize:
        '''
        bev_size = (int(round((bev_zLimits[1] - bev_zLimits[0]) / bev_res)), \
                   int(round((bev_xLimits[1] - bev_xLimits[0]) / bev_res)))
...
class KittiCalibration(object):
    ...
    def readFromFile(self, filekey = None, fn = None):
        ...
        assert fn is not None, 'Problem! fn or filekey must be is not None'
